class StudentManagement {
    ...
    showList() {
        ...
        for (let i = 0; i < this.students.length; i++) {
            ...
            table += "<td>";
            table += "<button style='background-color: red; color: white;' type='button' onclick='deleteStudent(" + i + ")'>Delete</button>";
            table += "<button style='background-color: red; color: white;' type='button' onclick='editStudent(" + i + ")'>Edit</button>";
            table += "</td>";

...
select *
from nhan_vien nv
where (select substring_index(nv.ho_ten, ' ', -1) regexp '^[H,K,Y]')
...
select kh.ma_khach_hang,
       ...
       hd.ngay_ket_thuc,
       ifnull(dv.chi_phi_thue, 0) + ifnull(hdct.so_luong, 0) * ifnull(dvdk.gia, 0) as tong_chi_phi
from khach_hang kh

...
<h6><a class="a-create" href="/facility?action=create&type=villa">Add New Villa</a></h6>
<h6><a class="a-create" href="/facility?action=create&type=house">Add New House</a></h6>
<h6><a class="a-create" href="/facility?action=create&type=room">Add New Room</a></h6>
...
<h6 style="color: blue"><a style="color: blue" href="/facility">Back to Facility List</a></h6>
<table id="tableCustomer" class="table table-striped table-bordered" style="width: 100%">
    ...
    <tbody>
    <c:forEach var="facility" items="${facilitySearchList}" varStatus="status">
        <tr>
            <td>${status.count}</td>

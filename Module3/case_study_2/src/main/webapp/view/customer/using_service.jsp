...
<table id="tableCustomer" class="table table-striped table-bordered" style="width: 100%">
    ...
    <tbody>
    <c:forEach var="customer" items="${customerContractList}" varStatus="status">
        <tr>
            <td>${status.count}</td>
            <td>${customer.name}</td>
            ...
            <td>${customer.numberOfContracts}</td>
            <td>
                <button type="button"
                        class="btn btn-sm btn-danger" data-bs-toggle="modal"
                        data-bs-target="#modalAttachFacility">
                    Click to view
                </button>
            </td>
...
<%--Modal--%>
<div class="modal fade" id="modalAttachFacility" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">

...
<form action="/facility?action=createHouse" method="post">
    <center>
        <input type="hidden" value="2" name="facilityTypeId">
    <table>
        <tr>
            <td>Facility Type: </td>
            <td>
                    <input disabled type="text" value="House" name="facilityType">
            </td>
        </tr>
        <tr>
            <td>Facility Name: </td>
            <td>
                <input type="text" size="20" name="name" value="House " required>
            </td>
        </tr>
        <tr>
            <td>Area:</td>
